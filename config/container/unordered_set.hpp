...
#ifndef LIB_CONTAINER_UNORDERED_unordered_set_TPP_
#define LIB_CONTAINER_UNORDERED_unordered_set_TPP_
...
template<typename X_t, typename...X> constexpr bool unique_values< std::unordered_set<X_t, X...> > = true;
template<typename X_t, typename...X> constexpr bool is_ordered < std::unordered_set<X_t, X...> >       = false;
...
struct Add_anywhere_t< std::unordered_set<X_t, X...> >{
	Add_anywhere_t()=delete;

	typedef std::unordered_set<X_t, X...> container_t;
...
template<typename X_t, typename ... X>
struct Emplace_anywhere_t< std::unordered_set<X_t, X...> >{
...
//--- get ---
//get_front    : UNIMPLEMENTED (not allowed to modify unordered_set elements)
//get_back     : UNIMPLEMENTED (not allowed to modify unordered_set elements)
//get_anywhere : UNIMPLEMENTED (not allowed to modify unordered_set elements)
//get_here     : UNIMPLEMENTED (not allowed to modify unordered_set elements)
//cget_xxx     : IMPLEMENTED, as reading const value is OK


//cget_front
template<typename X_t, typename ... X>
struct Cget_front_t< std::unordered_set<X_t,X...> >{
	Cget_front_t()=delete;
	typedef std::unordered_set<X_t,X...> container_t;
...
//cget_back
template<typename X_t, typename ... X>
struct Cget_back_t< std::unordered_set<X_t,X...> >{
	Cget_back_t()=delete;
	typedef std::unordered_set<X_t,X...> container_t;

	static decltype(auto) run(const container_t &c){
		auto it = c.cbegin();
		if(c.size()>1){
...
//cget_anywhere
template<typename X_t, typename ... X>
struct Cget_anywhere_t<std::unordered_set<X_t,X...> > : Cget_back_t<std::unordered_set<X_t,X...>>{};


//cget_here
template<typename X_t, typename ... X>
struct Cget_here_t< std::unordered_set<X_t,X...> >{
	Cget_here_t()=delete;
	typedef std::unordered_set<X_t,X...> container_t;
...
//--- remove ---
template<typename X_t, typename ... X>
struct Remove_front_t< std::unordered_set<X_t,X...> >{
...
template<typename X_t, typename ... X>
struct Remove_back_t< std::unordered_set<X_t,X...> >{
...
template<typename X_t, typename ... X>
struct Remove_anywhere_t<std::unordered_set<X_t,X...> > : Remove_back_t<std::unordered_set<X_t,X...>>{};


template<typename X_t, typename ... X>
struct Remove_here_t< std::unordered_set<X_t,X...> >{
...
template<typename X_t, typename ... X>
struct Mem_capacity_t< std::unordered_set<X_t,X...> >{
...
//--- count ---
template<typename X_t, typename ... X>
struct Count_empty_t< std::unordered_set<X_t,X...> >{
...
template<typename X_t, typename ... X>
struct Count_all_t< std::unordered_set<X_t,X...> >{
	Count_all_t()=delete;
	typedef std::unordered_set<X_t,X...> container_t;
...
template<typename X_t, typename ... X>
struct Count_element_t< std::unordered_set<X_t,X...> >{
